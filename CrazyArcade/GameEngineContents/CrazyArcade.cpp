...
void CrazyArcade::GameInit()
{
    ...
    ////// UI 리소스 Play에서 사용되는 리소스
    {
        ...
        Image = GameEngineImageManager::GetInst()->Find("DaoFace_Icon.bmp");
        Image->Cut({ 64,64 });
    ...
    GameEngineImage* DestroyBlock = GameEngineImageManager::GetInst()->Find("DestroyBlock.bmp");
    DestroyBlock->CutCount(4, 1);
   //////////////////////////////아래 게임 키 설정//////////////////////////////
